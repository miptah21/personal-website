      ...
      <div className={styles.container}>
        <div className={styles.heroGrid}>
          <div className={styles.heroLeft}>
            <ScrollReveal delay={0.05} priority={true}>
            ...
            <div className={styles.heroBody}>
              ...
              <ScrollReveal delay={0.2} priority={true}>
          ...
          <ScrollReveal delay={0.15} direction="left" className={styles.heroRight} priority={true}>
